        ...
        <div className="flex min-h-screen flex-col">
          ...
          <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-12 md:px-6">
            ...
            <div className="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Days Together", value: "1,024", icon: Heart, color: "rose" as const },
                { label: "Memories", value: "238", icon: ImageIcon, color: "purple" as const },
                { label: "Anniversaries", value: "12", icon: Calendar, color: "indigo" as const },
                { label: "Challenges", value: "34", icon: Trophy, color: "rose" as const },
              ].map((stat) => (
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              <GlassCard intensity="medium" className="p-6">
                ...
                <ul className="space-y-4">
                  {["Next anniversary in 14 days", "Date night reminder: Friday", "6 month trip plan"].map((item) => (
              ...
              <GlassCard intensity="medium" className="p-6">
                ...
                <ul className="space-y-4">
                  {["Added 3 new memories", "Completed couple challenge", "Shared a love note"].map((item) => (
                    <li key={item} className="flex items-center gap-3 text-sm text-muted-foreground">
